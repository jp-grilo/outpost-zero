...
var tower_evolution_tree = {
	"turret_1_fase2": ["turret_2_fase2"],
	"turret_2_fase2": ["turret_3_fase2"],
	"turret_21_fase2": ["turret_22_fase2"],
...
func _render_upgrade_buttons():
	...
	for evolution_name in evolutions:
		var scene_path = "res://Scenes/turrets_fase2/%s.tscn" % evolution_name
