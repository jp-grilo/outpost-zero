...
func _build_base():
	...
	if sprite:
		sprite.texture = preload("res://assets/sprites/CENARIO_OZ V1.1/Cenario2/Fase2_Talvez.png")
...
func _unlock_tower():
	...
	if sprite:
		sprite.texture = preload("res://assets/sprites/CENARIO_OZ V1.1/Cenario2/Fase2_torreDireita.png")
	if torre1:
		torre1.visible = true
	if torre2:
		torre2.visible = true
...
func _expand_area():
	...
	if sprite:
		sprite.texture = preload("res://assets/sprites/CENARIO_OZ V1.1/Cenario2/Fase2_Completa.png")
	if torre1:
		torre1.visible = true
	if torre2:
		torre2.visible = true
